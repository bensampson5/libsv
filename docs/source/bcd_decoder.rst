...
The BCD input , ``i_bin``, is a ``4*N`` bit wide input vector where each 4 bits represents one decimal digit. The output binary value, ``o_bcd``,
...
Implementation
--------------
.. literalinclude:: ../../src/encode_decode/bcd_decoder/bcd_decoder.sv
